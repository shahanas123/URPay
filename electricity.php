            ...
            <div class="col col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                ...
                <div class="form-floating">
                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                      ...
                      <option value="2">BSES</option>
                      <option value="3">TNEB</option>
                      <option value="4">TATA POWER</option>
                    </select>
                    <label for="floatingSelect">Distributor Name</label>
                    
            
                  </div> 
                  <form class="form-floating">
                    <input type="email" class="form-control" id="floatingInputValue" placeholder="Consumer Number" value="">
                    <label for="floatingInputValue">Consumer Number</label>
                    <a class="btn btn-outline-primary me-2" href="" >PAY</a>
                  </form>
